...
interface Props {
  post?: Post; // undefined for new post
}
  ...
  return (
    <div className="max-w-3xl mx-auto px-5 py-10 animate-fade-in">
      ...
      <div className="flex items-center justify-between mb-8">
        <h1 className="text-[28px] font-semibold tracking-[-0.02em] text-apple-text">
          {isEdit ? '编辑文章' : '写新文章'}
        </h1>
      ...
      {error && (
        <div className="mb-6 text-sm text-red-500 bg-red-50 px-4 py-3 rounded-apple-sm">
          {error}
        </div>
      )}
      ...
      <form className="space-y-6 card p-6 sm:p-8">
        {/* Title */}
        <div>
          <label className="block text-xs font-medium text-apple-secondary mb-2">
            标题
          </label>
          <input
            type="text"
            ...
            className="input-apple text-lg font-semibold"
            placeholder="输入文章标题..."
            required
          />
        </div>
        ...
        <div>
          ...
          {coverImage && (
            <img
              src={coverImage}
              alt="Cover preview"
              className="mt-3 w-full h-40 object-cover rounded-apple-sm"
            />
          )}
        </div>
        ...
        <div>
          <div className="flex items-center justify-between mb-2">
            <label className="text-xs font-medium text-apple-secondary">
              正文（支持 Markdown）
            </label>
          ...
          <textarea
            ...
            className="input-apple font-mono text-sm min-h-[400px] resize-y"
